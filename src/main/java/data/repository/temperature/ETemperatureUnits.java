...
/**
 * Enumeration of temperature units. Each unit has a description and a symbol.
 * This enum implements the {@link IExchangeableItem} interface and provides
 * methods to retrieve the description and symbol of each unit.
 */
