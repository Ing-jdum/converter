...
/**
 * Represents a currency repository implementation.
 * This enum serves as a singleton implementation of the {@link IItemRepository} and {@link ICurrencyRepository} interfaces.
 * It provides methods to retrieve currency items and their descriptions.
 * 
 * <p>Usage:
 ...
 * To retrieve all currencies, use the {@code getAllItems} method, which returns a list of exchangeable currencies.
 * To get the title of the repository, use the {@code getTitle} method.
 * To retrieve a specific currency item by its name, use the {@code getItemByName} method.
 * 
 * @see Currency
 */
public enum CurrencyRepositoryImpl implements IItemRepository, ICurrencyRepository {
     ...
     * @return an optional containing the currency item if found, or an empty optional if not found
     */
    @Override
