...
/**
 * Represents a conversion function. This interface defines a method to convert
 * a value from one unit to another.
 *
 * <p>
 * Usage: Implement this interface to define a custom conversion function. The
 * conversion function should take in two unit strings representing the source
 * and target units, and an input value to be converted. It should return the
 * converted value.
 *
 * <p>
 * Example implementation: Suppose you have a temperature conversion function
 * that converts from Celsius to Fahrenheit. You can implement this interface as
 * follows:
 *
 * <pre>{@code
